...
CLASS lcl_excelom_exprh_group        DEFINITION DEFERRED.
CLASS lcl_excelom_exprh_lexer        DEFINITION DEFERRED.
CLASS lcl_excelom_exprh_operator     DEFINITION DEFERRED.
CLASS lcl_excelom_exprh_parser       DEFINITION DEFERRED.
CLASS lcl_excelom_exprh_parser_item  DEFINITION DEFERRED.
CLASS lcl_excelom_expr_array         DEFINITION DEFERRED.
CLASS lcl_excelom_expr_boolean       DEFINITION DEFERRED.
CLASS lcl_excelom_expr_empty_arg     DEFINITION DEFERRED.
CLASS lcl_excelom_expr_error         DEFINITION DEFERRED.
CLASS lcl_excelom_expr_func_address  DEFINITION DEFERRED.
CLASS lcl_excelom_expr_func_cell     DEFINITION DEFERRED.
CLASS lcl_excelom_expr_func_find     DEFINITION DEFERRED.
CLASS lcl_excelom_expr_func_if       DEFINITION DEFERRED.
CLASS lcl_excelom_expr_func_iferror  DEFINITION DEFERRED.
CLASS lcl_excelom_expr_func_index    DEFINITION DEFERRED.
CLASS lcl_excelom_expr_func_indirect DEFINITION DEFERRED.
CLASS lcl_excelom_expr_func_len      DEFINITION DEFERRED.
CLASS lcl_excelom_expr_func_match    DEFINITION DEFERRED.
CLASS lcl_excelom_expr_func_offset   DEFINITION DEFERRED.
CLASS lcl_excelom_expr_func_right    DEFINITION DEFERRED.
CLASS lcl_excelom_expr_func_row      DEFINITION DEFERRED.
CLASS lcl_excelom_expr_func_t        DEFINITION DEFERRED.
CLASS lcl_excelom_expr_number        DEFINITION DEFERRED.
CLASS lcl_excelom_expr_op_ampersand  DEFINITION DEFERRED.
CLASS lcl_excelom_expr_op_colon      DEFINITION DEFERRED.
CLASS lcl_excelom_expr_op_equal      DEFINITION DEFERRED.
CLASS lcl_excelom_expr_op_minus      DEFINITION DEFERRED.
CLASS lcl_excelom_expr_op_mult       DEFINITION DEFERRED.
...
CLASS lcl_excelom_result_converter   DEFINITION DEFERRED.
CLASS lcl_excelom_result_empty       DEFINITION DEFERRED.
...
INTERFACE lif_excelom_expr.
  ...
  TYPES:
    BEGIN OF ts_operand_result,
      name                     TYPE string,
      object                   TYPE REF TO lif_excelom_result,
      "! <ul>
  ...
  TYPES:
    BEGIN OF ts_operand_expr,
      name                     TYPE string,
      object                   TYPE REF TO lif_excelom_expr,
      not_part_of_result_array TYPE abap_bool,
  ...
  CONSTANTS:
    BEGIN OF c_type,
      ...
      BEGIN OF operation,
        ...
        mult      TYPE ty_expression_type VALUE 13,
        plus      TYPE ty_expression_type VALUE 14,
      END OF operation,
    END OF c_type.

  DATA type                 TYPE ty_expression_type        READ-ONLY.
  DATA result_of_evaluation TYPE REF TO lif_excelom_result READ-ONLY.
...
INTERFACE lif_excelom_expr_array.
...
INTERFACE lif_excelom_result.
  ...
  "! and the same values. For instance, lcl_excelom_result_string=>create( '1'
  "! )->is_equal( lcl_excelom_result_string=>create( '1' ) ) is true, but
  "! lcl_excelom_result_number=>create( 1
  "! )->is_equal( lcl_excelom_result_string=>create( '1' ) ) is false.
  METHODS is_equal
    IMPORTING input_result  TYPE REF TO lif_excelom_result
    RETURNING VALUE(result) TYPE abap_bool.
...
INTERFACE lif_excelom_result_array.
  INTERFACES lif_excelom_result.

  TYPES tt_column TYPE STANDARD TABLE OF REF TO lif_excelom_result WITH EMPTY KEY.
  TYPES:
    BEGIN OF ts_row,
  ...
  METHODS get_array_value
    IMPORTING top_left      TYPE ts_address_one_cell
              bottom_right  TYPE ts_address_one_cell
    RETURNING VALUE(result) TYPE REF TO lif_excelom_result_array.
...
CLASS lcl_excelom_result_converter DEFINITION.
  public SECTION.
    interfaces lif_excelom_all_friends.

    CLASS-METHODS to_boolean
      IMPORTING !input         TYPE REF TO lif_excelom_result
...
CLASS lcl_excelom_exprh DEFINITION.
  PUBLIC SECTION.
    CLASS-METHODS evaluate_array_operands
      IMPORTING expression    TYPE REF TO lif_excelom_expr
                !context      TYPE REF TO lcl_excelom_evaluation_context
                operands      TYPE lif_excelom_expr=>tt_operand_expr
      RETURNING VALUE(result) TYPE lif_excelom_expr=>ts_evaluate_array_operands.
ENDCLASS.
...
CLASS lcl_excelom_exprh_parser_item DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    CLASS-METHODS create
      IMPORTING type       TYPE lcl_excelom_exprh_lexer=>ts_token-type
      RETURNING VALUE(result) TYPE REF TO lcl_excelom_exprh_parser_item.
ENDCLASS.
...
CLASS lcl_excelom_exprh_parser DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS get_expression_from_curly_brac
      IMPORTING
        arguments     TYPE lcl_excelom_exprh_parser_item=>tt_item
      RETURNING
...
CLASS lcl_excelom_expr_array DEFINITION FINAL
  ...
  PUBLIC SECTION.
    INTERFACES lif_excelom_expr_array.

    TYPES tt_column TYPE STANDARD TABLE OF REF TO lif_excelom_expr WITH EMPTY KEY.
    TYPES:
      BEGIN OF ts_row,
        columns_of_row TYPE tt_column,
      END OF ts_row.
...
CLASS lcl_excelom_expr_empty_arg DEFINITION FINAL
  CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      RETURNING VALUE(result) TYPE REF TO lcl_excelom_expr_empty_arg.

  PRIVATE SECTION.
ENDCLASS.


CLASS lcl_excelom_expr_error DEFINITION FINAL
  CREATE PRIVATE.
...
CLASS lcl_excelom_expr_func_address DEFINITION FINAL
  CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      IMPORTING row_num    TYPE REF TO lif_excelom_expr
                column_num TYPE REF TO lif_excelom_expr
                ABS_num    TYPE REF TO lif_excelom_expr OPTIONAL
                a1         TYPE REF TO lif_excelom_expr OPTIONAL
                Sheet_text TYPE REF TO lif_excelom_expr OPTIONAL
      RETURNING VALUE(result) TYPE REF TO lcl_excelom_expr_func_address.

  PRIVATE SECTION.
    DATA row_num    TYPE REF TO lif_excelom_expr.
    DATA column_num TYPE REF TO lif_excelom_expr.
    DATA abs_num    TYPE REF TO lif_excelom_expr.
    DATA a1         TYPE REF TO lif_excelom_expr.
    DATA sheet_text TYPE REF TO lif_excelom_expr.
ENDCLASS.
...
CLASS lcl_excelom_expr_func_cell DEFINITION FINAL
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      IMPORTING info_type TYPE REF TO lcl_excelom_expr_string
                reference TYPE REF TO lcl_excelom_expr_range OPTIONAL
  ...
  PRIVATE SECTION.
    ...
    DATA reference TYPE REF TO lcl_excelom_expr_range.
ENDCLASS.


"! COUNTIF(range, criteria)
"! https://support.microsoft.com/en-us/office/countif-function-e0de10c6-f885-4e71-abb4-1f464816df34
CLASS lcl_excelom_expr_func_countif DEFINITION FINAL
  CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      IMPORTING range    TYPE REF TO lif_excelom_expr
                criteria TYPE REF TO lif_excelom_expr OPTIONAL
      RETURNING VALUE(result) TYPE REF TO lcl_excelom_expr_func_countif.

  PRIVATE SECTION.
    DATA range    TYPE REF TO lif_excelom_expr.
    DATA criteria TYPE REF TO lif_excelom_expr.
ENDCLASS.
...
CLASS lcl_excelom_expr_func_find DEFINITION FINAL
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      IMPORTING find_text   TYPE REF TO lif_excelom_expr
                within_text TYPE REF TO lif_excelom_expr
                start_num   TYPE REF TO lif_excelom_expr OPTIONAL
      RETURNING VALUE(result) TYPE REF TO lcl_excelom_expr_func_FIND.

  PRIVATE SECTION.
    DATA find_text   TYPE REF TO lif_excelom_expr.
    DATA within_text TYPE REF TO lif_excelom_expr.
    DATA start_num   TYPE REF TO lif_excelom_expr.
ENDCLASS.
...
CLASS lcl_excelom_expr_func_iferror DEFINITION FINAL
  CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      IMPORTING !value         TYPE REF TO lif_excelom_expr
                value_if_error TYPE REF TO lif_excelom_expr
      RETURNING VALUE(result)  TYPE REF TO lcl_excelom_expr_func_iferror.

  PRIVATE SECTION.
    DATA value          TYPE REF TO lif_excelom_expr.
    DATA value_if_error TYPE REF TO lif_excelom_expr.
ENDCLASS.
...
CLASS lcl_excelom_expr_func_indirect DEFINITION FINAL
  CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      IMPORTING ref_text      TYPE REF TO lif_excelom_expr
                a1            TYPE REF TO lif_excelom_expr OPTIONAL
      RETURNING VALUE(result) TYPE REF TO lcl_excelom_expr_func_indirect.

  PRIVATE SECTION.
    DATA ref_text  TYPE REF TO lif_excelom_expr.
    DATA a1        TYPE REF TO lif_excelom_expr.
ENDCLASS.
...
CLASS lcl_excelom_expr_func_MATCH DEFINITION FINAL
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      IMPORTING lookup_value  TYPE REF TO lif_excelom_expr
                lookup_array  TYPE REF TO lif_excelom_expr OPTIONAL
                match_type    TYPE REF TO lif_excelom_expr OPTIONAL
      RETURNING VALUE(result) TYPE REF TO lcl_excelom_expr_func_match.

  PRIVATE SECTION.
    DATA lookup_value TYPE REF TO lif_excelom_expr.
    DATA lookup_array TYPE REF TO lif_excelom_expr.
    DATA match_type   TYPE REF TO lif_excelom_expr.
ENDCLASS.
...
CLASS lcl_excelom_expr_func_offset DEFINITION FINAL
  CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      IMPORTING !reference    TYPE REF TO lif_excelom_expr
                !rows         TYPE REF TO lif_excelom_expr
                cols          TYPE REF TO lif_excelom_expr
                height        TYPE REF TO lif_excelom_expr OPTIONAL
                !width        TYPE REF TO lif_excelom_expr OPTIONAL
      RETURNING VALUE(result) TYPE REF TO lcl_excelom_expr_func_offset.

  PRIVATE SECTION.
    DATA reference TYPE REF TO lif_excelom_expr.
    DATA rows      TYPE REF TO lif_excelom_expr.
    DATA cols      TYPE REF TO lif_excelom_expr.
    DATA height    TYPE REF TO lif_excelom_expr.
    DATA width     TYPE REF TO lif_excelom_expr.
ENDCLASS.
...
CLASS lcl_excelom_expr_func_ROW DEFINITION FINAL
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      IMPORTING reference     TYPE REF TO lif_excelom_expr OPTIONAL
      RETURNING VALUE(result) TYPE REF TO lcl_excelom_expr_func_ROW.
...
CLASS lcl_excelom_expr_func_t DEFINITION FINAL
  CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      IMPORTING value TYPE REF TO lif_excelom_expr
      RETURNING VALUE(result) TYPE REF TO lcl_excelom_expr_func_t.
...
CLASS lcl_excelom_expr_op_colon DEFINITION FINAL
  CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      IMPORTING left_operand  TYPE REF TO lif_excelom_expr
                right_operand TYPE REF TO lif_excelom_expr
      RETURNING VALUE(result) TYPE REF TO lcl_excelom_expr_op_colon.
...
CLASS lcl_excelom_expr_op_minus DEFINITION FINAL
  CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      IMPORTING left_operand  TYPE REF TO lif_excelom_expr
                right_operand TYPE REF TO lif_excelom_expr
      RETURNING VALUE(result) TYPE REF TO lcl_excelom_expr_op_minus.
...
*"! Is not final because it has subclass lcl_excelom_result_range.
CLASS lcl_excelom_range DEFINITION
  ...
  PUBLIC SECTION.
    INTERFACES lif_excelom_all_friends.
    INTERFACES lif_excelom_result_array.

    types:
        begin of ts_count_logic,
          columns_only type abap_bool,
          rows_only type abap_bool,
        end of ts_count_logic.
    ...
    CLASS-METHODS create_from_expr_range
      IMPORTING expr_range    TYPE REF TO lcl_excelom_expr_range
                relative_to   TYPE REF TO lcl_excelom_worksheet
      RETURNING VALUE(result) TYPE REF TO lcl_excelom_range.
  ...
  PRIVATE SECTION.
    DATA _address            TYPE lif_excelom_result_array=>ts_address.
    DATA _count_logic        TYPE ts_count_logic.
    ...
    "! @parameter count_logic | By default, the "count" method counts the number of cells.
    ...
    CLASS-METHODS create_from_top_left_bottom_ri
      IMPORTING worksheet     TYPE REF TO lcl_excelom_worksheet
                top_left      TYPE lif_excelom_result_array=>ts_address-top_left
                bottom_right  TYPE lif_excelom_result_array=>ts_address-bottom_right
                count_logic   TYPE ts_count_logic OPTIONAL
      RETURNING VALUE(result) TYPE REF TO lcl_excelom_range.

    CLASS-METHODS decode_range_address_a1
      IMPORTING address       TYPE string
      RETURNING VALUE(result) TYPE lif_excelom_result_array=>ts_address.
  ...
  DATA used_range TYPE ts_used_range READ-ONLY.
    ...
    CLASS-METHODS create_initial
      IMPORTING row_count    TYPE i
                column_count TYPE i
                rows type lif_excelom_result_array=>tt_row optional
      RETURNING VALUE(result)     TYPE REF TO lcl_excelom_result_array.
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF ts_cell,
        ...
        "! <li>If TYPE = C_TYPE-ERROR, the possible values are the internal numbers defined in LCL_EXCELOM_RESULT_ERROR</li>
        "! </ul>
        double     TYPE f,
        string     TYPE string,
      END OF ts_cell.
    TYPES tt_cell TYPE HASHED TABLE OF ts_cell WITH UNIQUE KEY row column.
  ...
  PRIVATE SECTION.
    TYPES:
      BEGIN OF ts_error,
        ...
        object                TYPE REF TO lcl_excelom_result_error,
      END OF ts_error.
    TYPES tt_error TYPE STANDARD TABLE OF ts_error WITH EMPTY KEY.
...
"! The class LCL_EXCELOM_RANGE is to be used instead of LCL_EXCELOM_RESULT_RANGE.
...
CLASS lcl_excelom_worksheet DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    DATA _array TYPE REF TO lcl_excelom_result_array.
ENDCLASS.
  ...
  METHOD evaluate_array_operands.
    ...
    LOOP AT operands REFERENCE INTO DATA(operand).
      ...
      ELSE.
        ...
        IF     operand_result->not_part_of_result_array = abap_false
           ...
           AND (    CAST lif_excelom_result_array( operand_result->object )->row_count    > 1
                 OR CAST lif_excelom_result_array( operand_result->object )->column_count > 1 ).
      ...
      CASE operand_result->object->type.
        WHEN operand_result->object->c_type-array
          ...
          max_row_count = nmax( val1 = max_row_count
                                val2 = CAST lif_excelom_result_array( operand_result->object )->row_count ).
          max_column_count = nmax( val1 = max_column_count
                                   val2 = CAST lif_excelom_result_array( operand_result->object )->column_count ).
      ENDCASE.
    ENDLOOP.

    DATA(target_array) = lcl_excelom_result_array=>create_initial( row_count    = max_row_count
    ...
    DO max_row_count TIMES.
      ...
      DO max_column_count TIMES.
        ...
        DATA(single_cell_operands) = VALUE lif_excelom_expr=>tt_operand_result( ).
        LOOP AT result-operand_results REFERENCE INTO operand_result.
          IF     operand_result->not_part_of_result_array  = abap_false
             AND operand_result->object                   IS BOUND.
            IF operand_result->object->type = operand_result->object->c_type-array.
              DATA(operand_result_array) = CAST lcl_excelom_result_array( operand_result->object ).
              DATA(cell) = operand_result_array->lif_excelom_result_array~get_cell_value( column = column
                                                                                          row    = row ).
            ELSEIF operand_result->object->type = operand_result->object->c_type-range.
              DATA(operand_result_range) = CAST lcl_excelom_range( operand_result->object ).
...
CLASS lcl_excelom_exprh_operator IMPLEMENTATION.
  ...
  METHOD create_expression.
    CASE name.
      ...
      WHEN '-'.
        result = lcl_excelom_expr_op_minus=>create( left_operand  = operands[ 1 ]
                                                    right_operand = operands[ 2 ] ).
      WHEN '*'.
      ...
      WHEN '&'.
        result = lcl_excelom_expr_op_ampersand=>create( left_operand  = operands[ 1 ]
                                                        right_operand = operands[ 2 ] ).
      WHEN ':'.
        result = lcl_excelom_expr_op_colon=>create( left_operand  = operands[ 1 ]
                                                        right_operand = operands[ 2 ] ).
      WHEN OTHERS.
...
CLASS lcl_excelom_exprh_parser IMPLEMENTATION.
  ...
  METHOD get_expression_from_curly_brac.
    result = lcl_excelom_expr_array=>create(
  ...
  METHOD get_expression_from_function.
    CASE function_name.
      WHEN 'ADDRESS'.
        result = lcl_excelom_expr_func_address=>create(
                     row_num    = arguments[ 1 ]
      ...
      WHEN 'CELL'.
        result = lcl_excelom_expr_func_cell=>create(
                     info_type = CAST #( arguments[ 1 ] )
                     reference = COND #( WHEN line_exists( arguments[ 2 ] ) THEN CAST #( arguments[ 2 ] ) ) ).
      WHEN 'COUNTIF'.
        result = lcl_excelom_expr_func_countif=>create( range    = arguments[ 1 ]
                                                        criteria = arguments[ 2 ] ).
      WHEN 'FIND'.
        result = lcl_excelom_expr_func_find=>create(
      ...
      WHEN 'IFERROR'.
        result = lcl_excelom_expr_func_iferror=>create( value          = arguments[ 1 ]
      ...
      WHEN 'INDIRECT'.
        result = lcl_excelom_expr_func_indirect=>create( ref_text = arguments[ 1 ]
                                                         a1       = COND #( WHEN line_exists( arguments[ 2 ] ) THEN arguments[ 2 ] ) ).
      WHEN 'LEN'.
        result = lcl_excelom_expr_func_len=>create( text = arguments[ 1 ] ).
      WHEN 'MATCH'.
        result = lcl_excelom_expr_func_match=>create(
                   lookup_value = arguments[ 1 ]
                   lookup_array = arguments[ 2 ]
                   match_type   = COND #( WHEN line_exists( arguments[ 3 ] ) THEN arguments[ 3 ] ) ).
      WHEN 'OFFSET'.
        result = lcl_excelom_expr_func_offset=>create(
  ...
  METHOD parse.
    ...
    DATA(initial_item) = lcl_excelom_exprh_parser_item=>create( type = '(' ).
    ...
    parse_tokens_until( EXPORTING until = lcl_excelom_exprh_lexer=>c_type-parenthesis_close
...
*    " Merge function item with its next item (arguments in parentheses) and ignore commas between arguments.
  ...
  METHOD parse_expression_item.
    WHILE current_token_index < lines( tokens ).
      ...
      CASE current_token->type.
        WHEN lcl_excelom_exprh_lexer=>c_type-parenthesis_open
          OR lcl_excelom_exprh_lexer=>c_type-function_name.
          parse_tokens_until( EXPORTING until = lcl_excelom_exprh_lexer=>c_type-parenthesis_close
                              CHANGING  item  = subitem ).
        WHEN lcl_excelom_exprh_lexer=>c_type-curly_bracket_open.
          parse_tokens_until( EXPORTING until = lcl_excelom_exprh_lexer=>c_type-curly_bracket_close
                              CHANGING  item  = subitem ).
        WHEN lcl_excelom_exprh_lexer=>c_type-table_name.
          parse_tokens_until( EXPORTING until = lcl_excelom_exprh_lexer=>c_type-square_bracket_close
                              CHANGING  item  = subitem ).
      ENDCASE.
  ...
  METHOD parse_expression_item_1.
    ...
    CASE item->type.
      WHEN lcl_excelom_exprh_lexer=>c_type-function_name
            OR lcl_excelom_exprh_lexer=>c_type-table_name.
        LOOP AT item->subitems INTO subitem.
          DATA(subitem_index) = sy-tabix.
          IF subitem->type = lcl_excelom_exprh_lexer=>c_type-comma.
            IF    subitem_index = lines( item->subitems )
               OR (     subitem_index < lines( item->subitems )
                    AND item->subitems[ subitem_index + 1 ]->type = lcl_excelom_exprh_lexer=>c_type-comma ).
              " RIGHT("hello",) (means RIGHT("hello",0)) -> arguments "hello" and empty
              " NB: RIGHT("hello") means RIGHT("hello",1)
              INSERT lcl_excelom_exprh_parser_item=>create( type = lcl_excelom_exprh_lexer=>c_type-empty_argument ) INTO item->subitems INDEX subitem_index + 1.
            ENDIF.
  ...
  METHOD parse_expression_item_2.
    ...
    LOOP AT item->subitems INTO subitem
      ...
      item_index = sy-tabix.
      DATA(unary) = COND abap_bool( WHEN item_index = 1 THEN
                                      abap_true
                                    WHEN item->subitems[ item_index - 1 ]->type = lcl_excelom_exprh_lexer=>c_type-operator THEN
                                      abap_true ).
  ...
  METHOD parse_expression_item_4.
    ...
    CASE item->type.
      ...
      WHEN lcl_excelom_exprh_lexer=>c_type-number.
        " NUMBER
        item->expression = lcl_excelom_expr_number=>create( CONV #( item->value ) ).
      WHEN lcl_excelom_exprh_lexer=>c_type-operator.
        " OPERATOR
        item->expression = lcl_excelom_exprh_operator=>get( operator = item->value
                                         unary    = xsdbool( lines( item->subitems ) = 1 ) )->create_expression(
                                             operands = VALUE #( FOR <subitem> IN item->subitems
                                                                 ( <subitem>->expression ) ) ).
      WHEN lcl_excelom_exprh_lexer=>c_type-semicolon.
      ...
      WHEN lcl_excelom_exprh_lexer=>c_type-text_literal.
        " TEXT LITERAL
        item->expression = lcl_excelom_expr_string=>create( item->value ).
      WHEN OTHERS.
        RAISE EXCEPTION TYPE lcx_excelom_to_do.
    ENDCASE.
  ENDMETHOD.
  ...
  METHOD parse_expression_item_5.
      types ty_ref_item type ref to lcl_excelom_exprh_parser_item.
    ...
    LOOP AT item->subitems INTO DATA(array)
         WHERE table_line->type = lcl_excelom_exprh_lexer=>c_type-curly_bracket_open.
      DATA(new_array_subitems) = VALUE lcl_excelom_exprh_parser_item=>tt_item( ).
      DATA(row) = VALUE ty_ref_item( ).
      LOOP AT array->subitems INTO DATA(array_subitem).
        CASE array_subitem->type.
          WHEN lcl_excelom_exprh_lexer=>c_type-comma.
          WHEN lcl_excelom_exprh_lexer=>c_type-semicolon.
            INSERT row INTO TABLE new_array_subitems.
            row = VALUE #( ).
          WHEN OTHERS.
            IF row IS NOT BOUND.
              row = NEW lcl_excelom_exprh_parser_item( ).
              row->type  = lcl_excelom_exprh_lexer=>c_type-semicolon.
              row->value = lcl_excelom_exprh_lexer=>c_type-semicolon.
            ENDIF.
...
CLASS lcl_excelom_exprh_parser_item IMPLEMENTATION.
  METHOD create.
    RESULT = new lcl_excelom_exprh_parser_item( ).
    result->type = type.
  ENDMETHOD.
ENDCLASS.
...
CLASS lcl_excelom_expr_array IMPLEMENTATION.
  METHOD create.
    result = NEW lcl_excelom_expr_array( ).
    result->lif_excelom_expr~type = result->lif_excelom_expr~c_type-array.
    result->rows = rows.
  ENDMETHOD.

  METHOD lif_excelom_expr~evaluate.
    result = lif_excelom_expr~set_result( lcl_excelom_result_array=>create_initial(
  ...
  METHOD lif_excelom_expr~is_equal.
    DATA(array) = CAST lcl_excelom_expr_array( expression ).
  ...
  METHOD lif_excelom_expr~set_result.
    lif_excelom_expr~result_of_evaluation = value.
    result = value.
  ENDMETHOD.
ENDCLASS.
...
CLASS lcl_excelom_expr_boolean IMPLEMENTATION.
  METHOD create.
    ...
    result->lif_excelom_expr~type = lif_excelom_expr=>c_type-boolean.
  ENDMETHOD.

  METHOD lif_excelom_expr~evaluate.
    result = lif_excelom_expr~set_result( lcl_excelom_result_boolean=>get( boolean_value ) ).
  ENDMETHOD.
...
CLASS lcl_excelom_expr_empty_arg IMPLEMENTATION.
  METHOD create.
    result = NEW lcl_excelom_expr_empty_arg( ).
    result->lif_excelom_expr~type = lif_excelom_expr=>c_type-empty_argument.
  ENDMETHOD.

  METHOD lif_excelom_expr~evaluate.
    result = lif_excelom_expr~set_result( lcl_excelom_result_empty=>get_singleton( ) ).
  ENDMETHOD.
...
CLASS lcl_excelom_expr_error IMPLEMENTATION.
  ...
  METHOD lif_excelom_expr~evaluate.
    result = lif_excelom_expr~set_result( lcl_excelom_result_error=>get_by_error_number( internal_error_number ) ).
  ENDMETHOD.
...
CLASS lcl_excelom_expr_func_address IMPLEMENTATION.
  METHOD create.
    result = NEW lcl_excelom_expr_func_address( ).
    result->lif_excelom_expr~type = lif_excelom_expr=>c_type-function-address.
...
CLASS lcl_excelom_expr_func_cell IMPLEMENTATION.
  ...
  METHOD lif_excelom_expr~evaluate.
    " In cell B1, formula =CELL("address",A1:A6) is the same result as
    " =CELL("address",A1), which is $A$1 in cell B1; the cells B2 to B6
    " are not initialized with $A$2, $A$3, etc.
    TYPES ty_ref_to_range TYPE REF TO lcl_excelom_range.
    DATA temp_result TYPE REF TO lcl_excelom_result_string.

    DATA(result_range) = COND ty_ref_to_range( WHEN reference IS BOUND
                            THEN lcl_excelom_range=>create_from_expr_range( expr_range  = reference
                                                                            relative_to = context->containing_cell->parent )
                            ELSE lcl_excelom_range=>create( cell1 = context->containing_cell ) ).

    DATA(result_top_left_cell) = result_range->cells( row    = 1
                                                      column = 1 ).
    DATA(info_type_result) = lcl_excelom_result_converter=>to_string( info_type->lif_excelom_expr~evaluate( context ) )->get_string( ).
    CASE info_type_result.
      WHEN c_info_type-filename.
        " Retourne par exemple "C:\temp\[Book1.xlsx]Sheet1"
        temp_result = lcl_excelom_result_string=>create( context->containing_cell->parent->parent->path
                                                    && |\\[{ context->containing_cell->parent->parent->name }]|
                                                    && context->containing_cell->parent->name ).
      WHEN OTHERS.
        RAISE EXCEPTION TYPE lcx_excelom_to_do.
    ENDCASE.
    result = lif_excelom_expr~set_result( temp_result ).
  ENDMETHOD.
...
CLASS lcl_excelom_expr_func_countif IMPLEMENTATION.
  METHOD create.
    result = NEW lcl_excelom_expr_func_countif( ).
    result->lif_excelom_expr~type = lif_excelom_expr=>c_type-function-countif.
    result->range    = range.
    result->criteria = criteria.
  ENDMETHOD.

  METHOD lif_excelom_expr~evaluate.
    DATA(array_evaluation) = lcl_excelom_exprh=>evaluate_array_operands(
                                 expression = me
                                 context    = context
                                 operands   = VALUE #( ( name = 'RANGE   ' object = range    not_part_of_result_array = abap_true )
                                                       ( name = 'CRITERIA' object = criteria ) ) ).
    result = lif_excelom_expr~set_result( COND #( WHEN array_evaluation-result IS BOUND
                                                  THEN array_evaluation-result
                                                  ELSE lif_excelom_expr~evaluate_single( arguments = array_evaluation-operand_results
                                                                                         context   = context ) ) ).
  ENDMETHOD.

  METHOD lif_excelom_expr~evaluate_single.
    DATA(result_of_range) = CAST lif_excelom_result_array( arguments[ name = 'RANGE' ]-object ).
    DATA(result_of_criteria) = lcl_excelom_result_converter=>to_string( arguments[ name = 'CRITERIA' ]-object )->get_string( ).
    ...
    WHILE row_number <= result_of_range->row_count.
      ...
      WHILE column_number <= result_of_range->column_count.
        DATA(cell_value_string) = lcl_excelom_result_converter=>to_string( result_of_range->get_cell_value(
    ...
    ENDWHILE.
    result = lcl_excelom_result_number=>create( CONV #( count_cells ) ).
  ENDMETHOD.
...
CLASS lcl_excelom_expr_func_find IMPLEMENTATION.
  METHOD create.
    result = NEW lcl_excelom_expr_func_find( ).
    result->lif_excelom_expr~type = lif_excelom_expr=>c_type-function-find.
  ...
  METHOD lif_excelom_expr~evaluate_single.
    DATA(result_of_find_text) = lcl_excelom_result_converter=>to_string( arguments[ name = 'FIND_TEXT' ]-object )->get_string( ).
    DATA(result_of_within_text) = lcl_excelom_result_converter=>to_string( arguments[ name = 'WITHIN_TEXT' ]-object )->get_string( ).
    DATA(result_of_start_num) = CAST lcl_excelom_result_number( arguments[ name = 'START_NUM' ]-object ).
    ...
    ELSE.
      ...
      IF result_offset = 0.
        result = lcl_excelom_result_error=>value_cannot_be_calculated.
      ELSE.
        result = lcl_excelom_result_number=>create( CONV #( result_offset ) ).
      ENDIF.
    ENDIF.
  ENDMETHOD.
...
CLASS lcl_excelom_expr_func_if IMPLEMENTATION.
  ...
  METHOD lif_excelom_expr~evaluate.
    DATA(condition_evaluation) = lcl_excelom_result_converter=>to_boolean( condition->evaluate( context ) ).
    result = lif_excelom_expr~set_result( COND #( WHEN condition_evaluation = lcl_excelom_result_boolean=>true
...
CLASS lcl_excelom_expr_func_iferror IMPLEMENTATION.
  METHOD create.
    result = NEW lcl_excelom_expr_func_iferror( ).
    result->lif_excelom_expr~type = lif_excelom_expr=>c_type-function-iferror.
    result->value                 = value.
  ...
  METHOD lif_excelom_expr~evaluate_single.
    result = lif_excelom_expr~set_result( COND #( LET value_result = arguments[ name = 'VALUE' ]-object
                                                  IN
                                                  WHEN value_result->type = lif_excelom_result=>c_type-error
...
CLASS lcl_excelom_expr_func_index IMPLEMENTATION.
  METHOD create.
    IF      array     IS NOT BOUND
      ...
      RAISE EXCEPTION TYPE lcx_excelom_to_do.
    ENDIF.
    result = NEW lcl_excelom_expr_func_index( ).
    result->lif_excelom_expr~type = lif_excelom_expr=>c_type-function-index.
    result->array      = array.
    result->row_num    = row_num.
    result->column_num = column_num.
  ENDMETHOD.
  ...
  METHOD lif_excelom_expr~evaluate_single.
    DATA(array_or_range) = CAST lif_excelom_result_array( arguments[ name = 'ARRAY' ]-object ).
    DATA(row) = lcl_excelom_result_converter=>to_number( arguments[ name = 'ROW_NUM' ]-object )->get_number( ).
    DATA(column) = lcl_excelom_result_converter=>to_number( arguments[ name = 'COLUMN_NUM' ]-object )->get_number( ).
    result = lif_excelom_expr~set_result( array_or_range->get_cell_value( column = EXACT #( column )
                                                                          row    = EXACT #( row ) ) ).
  ENDMETHOD.
...
CLASS lcl_excelom_expr_func_indirect IMPLEMENTATION.
  METHOD create.
    result = NEW lcl_excelom_expr_func_indirect( ).
    result->lif_excelom_expr~type = lif_excelom_expr=>c_type-function-indirect.
  ...
  METHOD lif_excelom_expr~evaluate.
    ...
    result = lif_excelom_expr~set_result( lcl_excelom_range=>create_from_address_or_name(
...
CLASS lcl_excelom_expr_func_len IMPLEMENTATION.
  ...
  METHOD lif_excelom_expr~evaluate_single.
    result = lif_excelom_expr~set_result( lcl_excelom_result_number=>create(
                                              strlen( lcl_excelom_result_converter=>to_string(
                                                          arguments[ name = 'TEXT' ]-object )->get_string( ) ) ) ).
  ENDMETHOD.

  METHOD lif_excelom_expr~is_equal.
    IF expression->type <> lif_excelom_expr=>c_type-function-len.
      RETURN.
    ENDIF.
    DATA(len) = CAST lcl_excelom_expr_func_len( expression ).
...
CLASS lcl_excelom_expr_func_match IMPLEMENTATION.
  METHOD create.
    result = NEW lcl_excelom_expr_func_match( ).
    result->lif_excelom_expr~type = lif_excelom_expr=>c_type-function-match.
  ...
  METHOD lif_excelom_expr~evaluate_single.
    DATA temp_result TYPE REF TO lif_excelom_result.

    DATA(lookup_value_result) = arguments[ name = 'LOOKUP_VALUE' ]-object.
    DATA(lookup_array_result) = CAST lif_excelom_result_array( arguments[ name = 'LOOKUP_ARRAY' ]-object ).
    DATA(match_type_result) = COND i( LET result_num_chars = arguments[ name = 'MATCH_TYPE' ]-object IN
                              ...
                              THEN COND #( WHEN result_num_chars->type = result_num_chars->c_type-empty
                                           THEN 1
                                           ELSE lcl_excelom_result_converter=>to_number( result_num_chars )->get_integer( ) ) ).
    IF match_type_result <> 0.
      RAISE EXCEPTION TYPE lcx_excelom_to_do.
    ENDIF.
    IF     lookup_array_result->row_count    > 1
       AND lookup_array_result->column_count > 1.
      temp_result = lcl_excelom_result_error=>na_not_applicable.
    ELSE.
      DATA(row_count) = 0.
      DATA(column_count) = 0.
      IF lookup_array_result->lif_excelom_result~type = lookup_array_result->lif_excelom_result~c_type-range.
        DATA(worksheet_used_range) = CAST lcl_excelom_range( lookup_array_result )->parent->used_range( ).
      ...
      WHILE row_number <= row_count.
        ...
        WHILE column_number <= column_count.
          ...
          DATA(lookup_value_result_2) = SWITCH #( lookup_value_result->type
                                                  WHEN lif_excelom_result=>c_type-array
                                                    OR lif_excelom_result=>c_type-range
                                                  THEN CAST lif_excelom_result( CAST lif_excelom_result_array( lookup_value_result )->get_cell_value(
                                                                                    column = 1
                                                                                    row    = 1 ) )
                                                  ELSE lookup_value_result ).
          IF    lookup_value_result_2->type = lif_excelom_result=>c_type-string
             OR cell_value->type            = lif_excelom_result=>c_type-string.
            equal = xsdbool( lcl_excelom_result_converter=>to_string( lookup_value_result_2 )->get_string( )
                             = lcl_excelom_result_converter=>to_string( cell_value )->get_string( ) ).
          ELSEIF    lookup_value_result_2->type = lif_excelom_result=>c_type-number
                 OR cell_value->type            = lif_excelom_result=>c_type-number.
            equal = xsdbool( lcl_excelom_result_converter=>to_number( lookup_value_result_2 )->get_number( )
                             = lcl_excelom_result_converter=>to_number( cell_value )->get_number( ) ).
          ELSEIF    lookup_value_result_2->type = lif_excelom_result=>c_type-boolean
                 OR cell_value->type            = lif_excelom_result=>c_type-boolean.
            equal = xsdbool( lcl_excelom_result_converter=>to_boolean( lookup_value_result_2 )->boolean_value
                             = lcl_excelom_result_converter=>to_boolean( cell_value )->boolean_value ).
          ELSEIF     lookup_value_result_2->type = lif_excelom_result=>c_type-empty
                 AND cell_value->type            = lif_excelom_result=>c_type-empty.
            equal = abap_true.
          ELSE.
            RAISE EXCEPTION TYPE lcx_excelom_to_do.
          ENDIF.
*          CASE lookup_value_result->type.
*            WHEN lookup_value_result->c_type-boolean.
*              CASE cell_value->type.
*                WHEN cell_value->c_type-boolean.
*                  equal = xsdbool( lookup_value_result = cell_value ).
**                  equal = xsdbool( cast lcl_excelom_result_boolean( lookup_value_result ) = cast lcl_excelom_result_boolean( cell_value ) ).
*                WHEN cell_value->c_type-empty.
*                WHEN cell_value->c_type-error.
*                WHEN cell_value->c_type-number.
*                  equal = xsdbool( CAST lcl_excelom_result_boolean( lookup_value_result )->boolean_value
*                                   = xsdbool( 0 <> CAST lcl_excelom_result_number( cell_value )->get_number( ) ) ).
*                WHEN cell_value->c_type-string.
*                  equal = xsdbool( CAST lcl_excelom_result_boolean( lookup_value_result ) = CAST lcl_excelom_result_boolean( cell_value ) ).
*                WHEN OTHERS.
*                  RAISE EXCEPTION TYPE lcx_excelom_unexpected.
*              ENDCASE.
*            WHEN lookup_value_result->c_type-empty.
*            WHEN lookup_value_result->c_type-error.
*            WHEN lookup_value_result->c_type-number.
*            WHEN lookup_value_result->c_type-string.
*            WHEN OTHERS.
*              RAISE EXCEPTION TYPE lcx_excelom_unexpected.
*          ENDCASE.
          IF equal = abap_true.
            IF lookup_array_result->row_count > 1.
              temp_result = lcl_excelom_result_number=>create( EXACT #( row_number ) ).
            ELSE.
              temp_result = lcl_excelom_result_number=>create( EXACT #( column_number ) ).
            ENDIF.
...
CLASS lcl_excelom_expr_func_offset IMPLEMENTATION.
  METHOD create.
    result = NEW lcl_excelom_expr_func_offset( ).
    result->lif_excelom_expr~type = lif_excelom_expr=>c_type-function-offset.
    result->reference             = reference.
    result->rows                  = rows.
    result->cols                  = cols.
  ...
  METHOD lif_excelom_expr~evaluate_single.
    DATA(rows_result) = lcl_excelom_result_converter=>to_number( arguments[ name = 'ROWS' ]-object )->get_integer( ).
    DATA(cols_result) = lcl_excelom_result_converter=>to_number( arguments[ name = 'COLS' ]-object )->get_integer( ).
    ...
    DATA(height_result) = COND #( WHEN height       IS BOUND
                                  ...
                                  THEN lcl_excelom_result_converter=>to_number( arguments[
    ...
    DATA(width_result) = COND #( WHEN width       IS BOUND
                                 ...
                                 ELSE cols_result ).
    result = lif_excelom_expr~set_result( reference_result->offset( row_offset    = rows_result
...
CLASS lcl_excelom_expr_func_right IMPLEMENTATION.
  METHOD create.
    result = NEW lcl_excelom_expr_func_right( ).
    result->lif_excelom_expr~type = lif_excelom_expr=>c_type-function-right.
    result->text                  = text.
  ...
  METHOD lif_excelom_expr~evaluate_single.
    ...
    DATA(text) = lcl_excelom_result_converter=>to_string( arguments[ name = 'TEXT' ]-object )->get_string( ).
    ...
    DATA(number_num_chars) = COND #( WHEN result_num_chars IS BOUND
                                     ...
                                     THEN lcl_excelom_result_converter=>to_number( result_num_chars )->get_number( ) ).
    IF number_num_chars < 0.
      temp_result = lcl_excelom_result_error=>value_cannot_be_calculated.
    ELSE.
      IF text = ''.
        right = ``.
      ELSE.
        ...
        right = substring( val = text
                           off = off ).
      ENDIF.
      temp_result = lcl_excelom_result_string=>create( right ).
    ENDIF.
    result = lif_excelom_expr~set_result( temp_result ).
  ENDMETHOD.

  METHOD lif_excelom_expr~is_equal.
    IF expression->type <> lif_excelom_expr=>c_type-function-right.
      RETURN.
    ENDIF.
    DATA(compare_right) = CAST lcl_excelom_expr_func_right( expression ).

    result = xsdbool(     text->is_equal( compare_right->text )
                      AND (    (     num_chars                IS NOT BOUND
                                 AND compare_right->num_chars IS NOT BOUND )
...
CLASS lcl_excelom_expr_func_row IMPLEMENTATION.
  METHOD create.
    result = NEW lcl_excelom_expr_func_row( ).
    result->lif_excelom_expr~type = lif_excelom_expr=>c_type-function-row.
    result->reference             = reference.
  ENDMETHOD.
  ...
  METHOD lif_excelom_expr~evaluate_single.
    ...
    IF reference IS NOT BOUND.
      temp_result = lcl_excelom_result_number=>create( context->containing_cell->row( ) ).
    ELSE.
      DATA(reference_result) = CAST lcl_excelom_range( arguments[ name = 'REFERENCE' ]-object ).
      temp_result = lcl_excelom_result_number=>create( reference_result->row( ) ).
    ENDIF.
    result = lif_excelom_expr~set_result( temp_result ).
  ENDMETHOD.
...
CLASS lcl_excelom_expr_func_t IMPLEMENTATION.
  METHOD create.
    result = NEW lcl_excelom_expr_func_t( ).
    result->lif_excelom_expr~type = lif_excelom_expr=>c_type-function-t.
    result->value                 = value.
  ENDMETHOD.
  ...
  METHOD lif_excelom_expr~evaluate_single.
    ...
    result = lif_excelom_expr~set_result(
                 lcl_excelom_result_string=>create( COND #( WHEN value_result->type = value_result->c_type-string
                                                            THEN lcl_excelom_result_converter=>to_string( value_result )->get_string( )
                                                            ELSE '' ) ) ).
  ENDMETHOD.
...
CLASS lcl_excelom_expr_number IMPLEMENTATION.
  ...
  METHOD lif_excelom_expr~evaluate.
    result = lif_excelom_expr~set_result( lcl_excelom_result_number=>create( number ) ).
  ENDMETHOD.
...
CLASS lcl_excelom_expr_op_ampersand IMPLEMENTATION.
  ...
  METHOD lif_excelom_expr~evaluate_single.
    result = lif_excelom_expr~set_result(
                 lcl_excelom_result_string=>create(
                     lcl_excelom_result_converter=>to_string( arguments[ name = 'LEFT' ]-object )->get_string( )
                  && lcl_excelom_result_converter=>to_string( arguments[ name = 'RIGHT' ]-object )->get_string( ) ) ).
  ENDMETHOD.
...
CLASS lcl_excelom_expr_op_colon IMPLEMENTATION.
  METHOD create.
    result = NEW lcl_excelom_expr_op_colon( ).
  ...
  METHOD lif_excelom_expr~evaluate.
    DATA(cell1) = SWITCH #( left_operand->type
                            WHEN left_operand->c_type-number THEN
                              |{ CAST lcl_excelom_result_number( left_operand->evaluate( context ) )->get_integer( ) }|
                            WHEN left_operand->c_type-array
                              OR left_operand->c_type-range THEN
                              CAST lcl_excelom_expr_range( left_operand )->_address_or_name
                            ELSE
                              THROW lcx_excelom_to_do( ) ).
    DATA(cell2) = SWITCH #( right_operand->type
                            WHEN right_operand->c_type-number THEN
                              |{ CAST lcl_excelom_result_number( right_operand->evaluate( context ) )->get_integer( ) }|
                            WHEN left_operand->c_type-array
                              OR left_operand->c_type-range THEN
                              CAST lcl_excelom_expr_range( right_operand )->_address_or_name
                            ELSE
                              THROW lcx_excelom_to_do( ) ).
    result = lif_excelom_expr~set_result(
                 lcl_excelom_range=>create( lcl_excelom_range=>create_from_address_or_name(
                                                address     = |{ cell1 }:{ cell2 }|
                                                relative_to = context->containing_cell->parent ) ) ).
  ENDMETHOD.
  ...
  METHOD lif_excelom_expr~is_equal.
    IF     expression IS BOUND
       ...
       AND left_operand->is_equal( CAST lcl_excelom_expr_op_colon( expression )->left_operand )
       AND right_operand->is_equal( CAST lcl_excelom_expr_op_colon( expression )->right_operand ).
      result = abap_true.
    ELSE.
      result = abap_false.
    ENDIF.
...
CLASS lcl_excelom_expr_op_equal IMPLEMENTATION.
  ...
  METHOD lif_excelom_expr~evaluate_single.
    ...
    IF left_result->type <> right_result->type.
      temp_result = lcl_excelom_result_boolean=>false.
    ELSE.
      ...
      temp_result = lcl_excelom_result_boolean=>get( xsdbool( <left_operand_value> = <right_operand_value> ) ).
    ENDIF.
    result = lif_excelom_expr~set_result( temp_result ).
  ENDMETHOD.
...
CLASS lcl_excelom_expr_op_minus IMPLEMENTATION.
  METHOD create.
    result = NEW lcl_excelom_expr_op_minus( ).
    result->left_operand          = left_operand.
    result->right_operand         = right_operand.
    result->lif_excelom_expr~type = lif_excelom_expr=>c_type-operation-minus.
  ENDMETHOD.
  ...
  METHOD lif_excelom_expr~evaluate_single.
    result = lif_excelom_expr~set_result(
                 lcl_excelom_result_number=>create(
                     lcl_excelom_result_converter=>to_number( arguments[ name = 'LEFT' ]-object )->get_number( )
                   - lcl_excelom_result_converter=>to_number( arguments[ name = 'RIGHT' ]-object )->get_number( ) ) ).
  ENDMETHOD.

  METHOD lif_excelom_expr~is_equal.
    IF     expression IS BOUND
       AND expression->type = lif_excelom_expr=>c_type-operation-minus
       AND left_operand->is_equal( CAST lcl_excelom_expr_op_minus( expression )->left_operand )
       AND right_operand->is_equal( CAST lcl_excelom_expr_op_minus( expression )->right_operand ).
      result = abap_true.
    ELSE.
      result = abap_false.
    ENDIF.
...
CLASS lcl_excelom_expr_string IMPLEMENTATION.
  METHOD create.
    ...
    result->string = text.
    result->lif_excelom_expr~type = lif_excelom_expr=>c_type-string.
  ENDMETHOD.

  METHOD lif_excelom_expr~evaluate.
    result = lif_excelom_expr~set_result( lcl_excelom_result_string=>create( string ) ).
  ENDMETHOD.
  ...
  METHOD lif_excelom_expr~is_equal.
    IF expression->type <> lif_excelom_expr=>c_type-string.
      RETURN.
    ENDIF.
    DATA(string_object) = CAST lcl_excelom_expr_string( expression ).
...
CLASS lcl_excelom_range IMPLEMENTATION.
  ...
  METHOD cells.
    ...
    result = lcl_excelom_range=>create_from_row_column( worksheet = parent
                                                        row       = _address-top_left-row + row - 1
                                                        column    = _address-top_left-column + column - 1 ).
  ENDMETHOD.

  METHOD columns.
    result = lcl_excelom_range=>create_from_top_left_bottom_ri( worksheet    = parent
                                                                top_left     = _address-top_left
                                                                bottom_right = _address-bottom_right
                                                                count_logic  = VALUE #( columns_only = abap_true ) ).
  ENDMETHOD.

  METHOD count.
    CASE abap_true.
      WHEN _count_logic-columns_only.
        result = lif_excelom_result_array~column_count. "_address-bottom_right-column - _address-top_left-column + 1.
      WHEN _count_logic-rows_only.
        result = lif_excelom_result_array~row_count. "_address-bottom_right-column - _address-top_left-column + 1.
      WHEN OTHERS.
        result = lif_excelom_result_array~column_count * lif_excelom_result_array~row_count.
    ENDCASE.
  ENDMETHOD.
  ...
  METHOD create.
    ...
    DATA(structured_address) = VALUE lif_excelom_result_array=>ts_address(
  ...
  METHOD create_from_address_or_name.
    ...
    result = create_from_top_left_bottom_ri( worksheet    = relative_to
                                             top_left     = structured_address-top_left
                                             bottom_right = structured_address-bottom_right ).
  ENDMETHOD.
  ...
  METHOD create_from_top_left_bottom_ri.
    ...
    result->parent                                = worksheet.
    result->_count_logic                          = count_logic.
    result->_address                              = VALUE #(
        ...
        bottom_right = VALUE #( row    = COND #( WHEN bottom_right-row > 0
                                                 ...
                                                 ELSE lcl_excelom_worksheet=>max_rows )
                                column = COND #( WHEN bottom_right-column > 0
                                                 THEN bottom_right-column
                                                 ELSE lcl_excelom_worksheet=>max_columns ) ) ).
...
*    result->lif_excelom_result_array~used_range = VALUE #(
*        top_left     = VALUE #( row    = nmax( val1 = result->_address-top_left-row
*                                               val2 = worksheet->_array->lif_excelom_result_array~used_range-top_left-row )
*                                column = nmax( val1 = result->_address-top_left-column
*                                               val2 = worksheet->_array->lif_excelom_result_array~used_range-top_left-column ) )
*        bottom_right = VALUE #( row    = nmin( val1 = result->_address-bottom_right-row
*                                               val2 = worksheet->_array->lif_excelom_result_array~used_range-bottom_right-row )
*                                column = nmin( val1 = result->_address-bottom_right-column
*                                               val2 = worksheet->_array->lif_excelom_result_array~used_range-bottom_right-column ) ) ).
*    result->lif_excelom_result_array~used_range-bottom_right = VALUE #( row = nmax( val1 = result->lif_excelom_result_array~used_range-top_left-row
*                                                                                    val2 = result->lif_excelom_result_array~used_range-bottom_right-row )
*                                                                        column = nmax( val1 = result->lif_excelom_result_array~used_range-top_left-column
*                                                                                    val2 = result->lif_excelom_result_array~used_range-bottom_right-column ) ).
  ENDMETHOD.
  ...
  METHOD rows.
    result = lcl_excelom_range=>create_from_top_left_bottom_ri( worksheet    = parent
                                                                top_left     = _address-top_left
                                                                bottom_right = _address-bottom_right
                                                                count_logic  = VALUE #( rows_only = abap_true ) ).
  ENDMETHOD.
  ...
  METHOD _set_value.
    parent->_array->lif_excelom_result_array~set_cell_value( row    = _address-top_left-row
  ...
  METHOD value.
    IF _address-top_left = _address-bottom_right.
      result = parent->_array->lif_excelom_result_array~get_cell_value( column = _address-top_left-column
                                                                        row    = _address-top_left-row ).
    ELSE.
      result = parent->_array->lif_excelom_result_array~get_array_value( top_left     = _address-top_left
                                                                         bottom_right = _address-bottom_right ).
    ENDIF.
  ENDMETHOD.
  ...
  METHOD lif_excelom_result~is_equal.
    IF     input_result->type = lif_excelom_result=>c_type-range.
      DATA(input_range) = CAST lcl_excelom_range( input_result ).
      IF     me->_address = input_range->_address
         AND me->formula2 = input_range->formula2.
        result = abap_true.
      ELSE.
        result = abap_false.
      ENDIF.
  ...
  METHOD lif_excelom_result_array~get_array_value.
  ...
  METHOD lif_excelom_result_array~get_cell_value.
    ...
    result = parent->_array->lif_excelom_result_array~get_cell_value( column = _address-top_left-column + column - 1
                                                                      row    = _address-top_left-row + row - 1 ).
  ENDMETHOD.

  METHOD lif_excelom_result_array~set_array_value.
    parent->_array->lif_excelom_result_array~set_array_value( rows = rows ).
  ENDMETHOD.

  METHOD lif_excelom_result_array~set_cell_value.
    RAISE EXCEPTION TYPE lcx_excelom_to_do.
  ENDMETHOD.
ENDCLASS.
...
CLASS lcl_excelom_result_array IMPLEMENTATION.
  ...
  METHOD create_initial.
    ...
    result->lif_excelom_result_array~row_count    = row_count.
    result->lif_excelom_result_array~column_count = column_count.
    result->lif_excelom_result_array~set_array_value( rows ).
    result->used_range = VALUE #( top_left     = VALUE #( row    = 1
                                                          column = 1 )
  ...
  METHOD lif_excelom_result_array~get_array_value.
    ...
    WHILE row <= row_count.
      ...
      WHILE column <= column_count.
        target_array->lif_excelom_result_array~set_cell_value(
            column = column
            row    = row
            value  = lif_excelom_result_array~get_cell_value( column = top_left-column + column - 1
  ...
  METHOD lif_excelom_result_array~get_cell_value.
    ...
    ELSE.
      CASE cell->value_type.
        WHEN c_value_type-boolean.
          IF cell->double = 0.
            result = lcl_excelom_result_boolean=>false.
          ELSE.
            result = lcl_excelom_result_boolean=>true.
          ENDIF.
        ...
        WHEN c_value_type-number.
          result = lcl_excelom_result_number=>create( number = cell->double ).
        WHEN c_value_type-string.
          result = lcl_excelom_result_string=>create( string = cell->string ).
        WHEN OTHERS.
          RAISE EXCEPTION TYPE lcx_excelom_to_do.
      ENDCASE.
    ENDIF.
  ...
  METHOD lif_excelom_result_array~set_array_value.
    ...
    LOOP AT rows REFERENCE INTO DATA(row2).
      ...
      LOOP AT row2->columns_of_row INTO DATA(column_value).
        lif_excelom_result_array~set_cell_value( column = column
                        row    = row
                        value  = column_value ).
        column = column + 1.
      ENDLOOP.
  ...
  METHOD lif_excelom_result_array~set_cell_value.
    IF    row    > lif_excelom_result_array~row_count
       OR row    < 1
       OR column > lif_excelom_result_array~column_count
       OR column < 1.
      RAISE EXCEPTION TYPE lcx_excelom_to_do.
    ENDIF.
    ...
    CASE value->type.
      ...
      WHEN value->c_type-array
        ...
        DATA(source_array) = CAST lif_excelom_result_array( value ).
  ...
  METHOD set_cell_value_single.
    ...
    ENDIF.
    CASE value->type.
      WHEN value->c_type-boolean.
        cell->value_type = c_value_type-boolean.
        cell->double     = CAST lcl_excelom_result_boolean( value )->number.
        cell->string     = ``.
      WHEN value->c_type-empty.
        cell->value_type = c_value_type-empty.
        cell->double     = 0.
        cell->string     = ``.
      WHEN value->c_type-error.
        cell->value_type = c_value_type-error.
        cell->double     = CAST lcl_excelom_result_error( value )->internal_error_number.
        cell->string     = ``.
      WHEN value->c_type-number.
        cell->value_type = c_value_type-number.
        cell->double     = CAST lcl_excelom_result_number( value )->get_number( ).
        cell->string     = ``.
      WHEN value->c_type-string.
        cell->value_type = c_value_type-string.
        cell->double     = 0.
        cell->string     = CAST lcl_excelom_result_string( value )->get_string( ).
      WHEN OTHERS.
        RAISE EXCEPTION TYPE lcx_excelom_to_do.
    ENDCASE.
  ...
  METHOD lif_excelom_result~is_equal.
    IF     input_result->type = lif_excelom_result=>c_type-array.
      DATA(input_array) = CAST lcl_excelom_result_array( input_result ).
      IF     lif_excelom_result_array~column_count = input_array->lif_excelom_result_array~column_count
         AND lif_excelom_result_array~row_count    = input_array->lif_excelom_result_array~row_count
...
CLASS lcl_excelom_result_empty IMPLEMENTATION.
  METHOD get_singleton.
    IF singleton IS NOT BOUND.
      ...
      singleton->lif_excelom_result~type = lif_excelom_result=>c_type-empty.
    ENDIF.
    result = singleton.
  ENDMETHOD.
...
CLASS lcl_excelom_result_number IMPLEMENTATION.
  ...
  METHOD lif_excelom_result~is_equal.
    IF input_result->type = lif_excelom_result=>c_type-number.
      DATA(input_number) = CAST lcl_excelom_result_number( input_result ).
...
CLASS lcl_excelom_result_string IMPLEMENTATION.
  ...
  METHOD lif_excelom_result~is_equal.
    result = xsdbool( string = CAST lcl_excelom_result_string( input_result )->get_string( ) ).
  ENDMETHOD.
...
*    ENDLOOP.
  ...
  METHOD create.
    ...
    result->_array = lcl_excelom_result_array=>create_initial( row_count    = max_rows
                                                               column_count = max_columns ).
  ENDMETHOD.

  METHOD decode_range_address.
    IF application->reference_style = lcl_excelom=>c_reference_style-a1.
      result = lcl_excelom_range=>decode_range_address_a1( address ).
    ELSE.
      result = lcl_excelom_range=>decode_range_address_r1_c1( address ).
    ENDIF.
...
*     result-name = parent->parent->names[ worksheet = parent ].
  ...
  METHOD used_range.
    result = lcl_excelom_range=>create_from_row_column(
                 worksheet   = me
...
CLASS lcl_excelom_result_converter IMPLEMENTATION.
  METHOD to_boolean.
    " If source is Number:
    "       FALSE if 0
    "       TRUE if not 0
    ...
    CASE input->type.
      ...
      WHEN input->c_type-number.
        CASE CAST lcl_excelom_result_number( input )->get_number( ).
          WHEN 0.
            result = lcl_excelom_result_boolean=>false.
          WHEN OTHERS.
            result = lcl_excelom_result_boolean=>true.
  ...
  METHOD to_number.
    ...
    IF input->type <> input->c_type-range.
      DATA(cell) = input.
    ELSE.
  ...
  METHOD to_string.
    CASE input->type.
      ...
      WHEN input->c_type-number.
        result = lcl_excelom_result_string=>create( |{ CAST lcl_excelom_result_number( input )->get_number( ) }| ).
      WHEN input->c_type-range.
        DATA(range) = CAST lcl_excelom_range( input ).
        IF range->_address-top_left <> range->_address-bottom_right.
          RAISE EXCEPTION TYPE lcx_excelom_to_do.
        ...
        DATA(string) = COND string( WHEN cell IS BOUND
                                    THEN SWITCH #( cell->value_type
                                                   WHEN lcl_excelom_result_array=>c_value_type-number THEN
                                                     |{ cell->double }|
                                                   WHEN lcl_excelom_result_array=>c_value_type-string THEN
                                                     cell->string
                                                   ELSE
                                                     THROW lcx_excelom_to_do( ) ) ).
...
CLASS ltc_evaluate DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS offset_2                   FOR TESTING RAISING cx_static_check.
    ...
    DATA: range_a2 TYPE REF TO lcl_excelom_range,
    ...
    METHODS assert_equals
      IMPORTING act            TYPE REF TO lif_excelom_result
                exp            TYPE REF TO lif_excelom_result
      RETURNING VALUE(result) TYPE abap_bool.
...
CLASS ltc_range DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    TYPES ty_address TYPE lif_excelom_result_array=>ts_address.
ENDCLASS.
...
CLASS ltc_evaluate IMPLEMENTATION.
  METHOD ampersand.
    ...
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_string( range_a1 )->get_string( )
                                        exp = `hello world` ).
  ...
  METHOD array.
    ...
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_number( range_a1 )->get_number( )
                                        exp = 1 ).
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_number( range_b1 )->get_number( )
                                        exp = 2 ).
  ENDMETHOD.
  ...
  METHOD cell.
    ...
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_string( range_a1->value( ) )->get_string( )
                                        exp = `\[]Sheet1` ).
    range_a2->set_value( lcl_excelom_result_string=>create( '' ) ).
  ...
  METHOD colon.
    range_a1->set_formula2( value = `COUNTIF(3:3,"")` ).
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_number( range_a1 )->get_number( )
                                        exp = 16384 ).
    range_a1->set_formula2( value = `COUNTIF(C:C,"")` ).
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_number( range_a1 )->get_number( )
                                        exp = 1048576 ).
  ENDMETHOD.
  ...
  METHOD countif.
    ...
    range_b1->set_value( lcl_excelom_result_string=>create( `peace` ) ).
    range_b2->set_value( lcl_excelom_result_string=>create( `love` ) ).
    range_c1->set_formula2( value = `COUNTIF(A1:B2,"*e*")` ).
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_number( range_c1->value( ) )->get_integer( )
                                        exp = 3 ).
  ENDMETHOD.

  METHOD equal.
    range_a1->set_formula2( value = `1=1` ).
    cl_abap_unit_assert=>assert_true( lcl_excelom_result_converter=>to_boolean( range_a1->value( ) )->boolean_value ).
  ENDMETHOD.
  ...
  METHOD index.
    range_b2->set_value( lcl_excelom_result_string=>create( `Hello` ) ).
  ...
  METHOD index_ae.
    range_A1->set_value( lcl_excelom_result_string=>create( `Hello ` ) ).
    range_b2->set_value( lcl_excelom_result_string=>create( `world` ) ).
    range_c1->set_formula2( value = `INDEX(A1:B2,{2,1},{2,1})` ).
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_string( range_c1->value( ) )->get_string( )
                                        exp = `world` ).
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_string( range_d1->value( ) )->get_string( )
                                        exp = `Hello ` ).

    range_a1->set_formula2( value = `INDEX({"a","b";"c","d"},{2,1},{2,1})` ).
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_string( range_a1->value( ) )->get_string( )
                                        exp = `d` ).
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_string( range_b1->value( ) )->get_string( )
                                        exp = `a` ).
  ENDMETHOD.
  ...
  METHOD offset.
    range_b2->set_value( lcl_excelom_result_string=>create( `hello` ) ).
    range_a1->set_formula2( value = `OFFSET(A1,1,1,1,1)` ).
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_string( range_a1->value( ) )->get_string( )
                                        exp = 'hello' ).
    range_a1->set_formula2( value = `OFFSET(A1,1,1)` ).
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_string( range_a1->value( ) )->get_string( )
                                        exp = 'hello' ).
    range_a1->set_formula2( value = `OFFSET(A1,1,1,,)` ).
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_string( range_a1->value( ) )->get_string( )
  ...
  METHOD offset_2.
    ...
    range_a2->set_value( lcl_excelom_result_string=>create( `hello` ) ).
    range_a1->set_formula2( value = `COUNTIF(OFFSET(1:1,1,0),"hello")` ).
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_number( range_a1->value( ) )->get_number( )
                                        exp = 1 ).
  ENDMETHOD.
  ...
  METHOD range_a1_plus_one.
    range_a1->set_value( lcl_excelom_result_number=>create( 10 ) ).
    DATA(range_a2) = worksheet->range_from_address( 'A2' ).
    range_a2->set_formula2( 'A1+1' ).
    cl_abap_unit_assert=>assert_equals( act = lcl_excelom_result_converter=>to_number( range_a2->value( ) )->get_number( )
                                        exp = 11 ).
  ENDMETHOD.
  ...
  METHOD t.
    ...
    assert_equals( act = range_a1->value( )
                   exp = lcl_excelom_result_string=>create( '1' ) ).
    range_a1->set_formula2( value = `T(1)` ).
    assert_equals( act = range_a1->value( )
                   exp = lcl_excelom_result_string=>create( '' ) ).
  ENDMETHOD.
ENDCLASS.
...
CLASS ltc_lexer IMPLEMENTATION.
  ...
  METHOD lexe.
    result = lcl_excelom_exprh_lexer=>create( )->lexe( text ).
  ENDMETHOD.
...
CLASS ltc_parser IMPLEMENTATION.
  METHOD array.
    assert_equals(
        act = parse( tokens = VALUE #( ( value = `{` type = c_type-curly_bracket_open )
                                       ...
                                       ( value = `2` type = c_type-number )
                                       ( value = `}` type = c_type-curly_bracket_close ) ) )
        exp = lcl_excelom_expr_array=>create(
                  rows = VALUE #( ( columns_of_row = VALUE #( ( lcl_excelom_expr_number=>create( 1 ) )
                                                              ( lcl_excelom_expr_number=>create( 2 ) ) ) ) ) ) ).
  ENDMETHOD.
  ...
  METHOD array_two_rows.
    assert_equals(
        ...
        exp = lcl_excelom_expr_array=>create(
                  rows = VALUE #( ( columns_of_row = VALUE #( ( lcl_excelom_expr_number=>create( 1 ) )
                                                              ( lcl_excelom_expr_number=>create( 2 ) ) ) )
                                  ( columns_of_row = VALUE #( ( lcl_excelom_expr_number=>create( 3 ) )
                                                              ( lcl_excelom_expr_number=>create( 4 ) ) ) ) ) ) ).
  ENDMETHOD.
  ...
  METHOD function_function.
    ...
    assert_equals(
        act = act
        exp = lcl_excelom_expr_func_len=>create( text = lcl_excelom_expr_func_right=>create(
                                                            text      = lcl_excelom_expr_string=>create( 'text' )
                                                            num_chars = lcl_excelom_expr_number=>create( 2 ) ) ) ).
  ENDMETHOD.
  ...
  METHOD function_optional_argument.
    ...
    assert_equals( act = act
                   exp = lcl_excelom_expr_func_right=>create( text      = lcl_excelom_expr_string=>create( 'text' )
                                                              num_chars = lcl_excelom_expr_empty_arg=>create( ) ) ).
  ENDMETHOD.
  ...
  METHOD operator_function.
    DATA(act) = parse( tokens = VALUE #( ( value = `1`    type = c_type-number )
                                         ...
                                         ( value = `)`    type = c_type-parenthesis_close ) ) ).
    assert_equals( act = act
                   exp = lcl_excelom_expr_op_plus=>create(
                             left_operand  = lcl_excelom_expr_number=>create( 1 )
                             right_operand = lcl_excelom_expr_func_len=>create(
                                                 text = lcl_excelom_expr_string=>create( 'text' ) ) ) ).
  ENDMETHOD.
    ...
    assert_equals( act = act
                   exp = lcl_excelom_expr_op_plus=>create(
                             ...
                             right_operand = lcl_excelom_expr_op_plus=>create(
                                                 left_operand  = lcl_excelom_expr_func_len=>create(
                                                                     text = lcl_excelom_expr_string=>create( 'text' ) )
                                                 right_operand = lcl_excelom_expr_number=>create( 1 ) ) ) ).
  ENDMETHOD.
