...
CLASS zcl_xlom__ex_fu_countif IMPLEMENTATION.
  ...
  METHOD zif_xlom__ex~evaluate_single.
    TRY.
        DATA(result_of_range) = CAST zif_xlom__va_array( arguments[ name = 'RANGE' ]-object ).
        DATA(result_of_criteria) = zcl_xlom__va=>to_string( arguments[ name = 'CRITERIA' ]-object )->get_string( ).
